...
#semiempirical
python $QMD_PATH/main_semiempirical_opt.py --input_smiles $input_smiles --XTB_path $XTB_PATH --RDMC_path $RDMC_PATH --G16_path $g16root/g16 --xyz_FF_dict $xyz_FF_dict --scratch_dir $scratch_dir
